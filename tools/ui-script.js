...
function renderBoard() {
  ...
  carsInDrawOrder.forEach((car) => {
    ...
    // véhicule.
    const cellTopY = cellPoly(car.col, car.row)[0][1];
  ...
  if (sel.step === "road-bonus-choice" && sel.car) {
    ...
    const front = [...rbSplit.onBoard, ...rbSplit.offBoard.filter((o) => o.outcome === "exits-front")].find((o) => o.direction === "front");
    if (front) {
